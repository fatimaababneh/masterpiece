...
<form action="{{ url('insert-category') }}" method="POST" style="margin:15vh auto auto 0; width:65vw;">
  ...
  <div class="form-group">
    ...
    <input  name="description" id="description" style="color:white;" class="form-control" placeholder="description">
  </div>
  <div class="form-group">
    <label for="brief">Brief</label>
    <textarea name="brief" id="brief" style="color:white;" class="form-control" placeholder="Brief" id="exampleFormControlTextarea1" rows="3"></textarea>
  </div>
  <div class="form-group">
